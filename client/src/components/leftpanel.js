    ...
    return (
        <ul className="left--panel">
            ...
            <li>
                ...
                <StrongBottomWithButton content = { achievement } btnname = "Check Records" address = "image--c01" />
            </li>
            <li>
            ...
            <li>
                ...
                <StrongBottomWithButton content = { certification } btnname = "Check Records" address = "image--c02" />
            </li>
            <li>
